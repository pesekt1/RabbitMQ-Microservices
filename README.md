...
You might need to fix the autogenerated manifests. Especially the ports.
...
```bash
docker push pesekt1/rabbitmq-microservices-main-frontend
docker push pesekt1/rabbitmq-microservices-main
docker push pesekt1/rabbitmq-microservices-admin-frontend
docker push pesekt1/rabbitmq-microservices-admin
```
...
port forwarding: because we will open the frontends in the browser and we need to access the services from outside of the cluster:
```bash
kubectl port-forward svc/main 8001:8001
